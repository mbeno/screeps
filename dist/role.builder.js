var roleBuilder = {
    ...
    //            creep.memory.role = 'idle';
	        ...
	        if (creep.memory.source == null) {
	            var structure_sources = _.filter(Game.spawns.Spawn1.room.find(FIND_STRUCTURES), (o) => {return (o.structureType == STRUCTURE_STORAGE || o.structureType == STRUCTURE_CONTAINER) && o.store[RESOURCE_ENERGY] > 500});
